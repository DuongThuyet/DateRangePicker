...
public class MonthView extends LinearLayout {
    ...
    public void init(MonthDescriptor month, List<List<MonthCellDescriptor>> cells,
        ...
        boolean isCurrentMonth = currentCal.get(Calendar.MONTH) == month.getMonth() && currentCal.get(Calendar.YEAR) == month.getYear();
        if (isCurrentMonth) {
            title.setTextColor(ContextCompat.getColor(this.getContext(), R.color.dateTimeRangePickerStateToday));
        } else {
            title.setTextColor(ContextCompat.getColor(this.getContext(), R.color.calendar_text_active));
        }
